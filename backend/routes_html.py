...
async def get_blogs_html():
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {
                "@type": "Blog",
                "@id": "https://payment-debug-14.preview.emergentagent.com/html/blogs#blog",
                ...
                "url": "https://payment-debug-14.preview.emergentagent.com/html/blogs",
                "publisher": {
                    "@type": "Organization",
                    "@id": "https://payment-debug-14.preview.emergentagent.com/#organization"
                },
                "about": {
                    "@type": "SoftwareApplication",
                    "@id": "https://payment-debug-14.preview.emergentagent.com/#product"
                }
            },
            {
                "@type": "SoftwareApplication",
                ...
                "offers": [
                    {
                        ...
                        "url": "https://payment-debug-14.preview.emergentagent.com/pricing"
                    },
                    {
                        "@type": "Offer",
                        "name": "Starter Plan",
            ...
            },
            {
                ...
                "@id": "https://payment-debug-14.preview.emergentagent.com/#organization",
                "name": "MailGuard",
                "url": "https://payment-debug-14.preview.emergentagent.com",
                "logo": {
                    "@type": "ImageObject",
                    "url": "https://payment-debug-14.preview.emergentagent.com/logo.png"
                },
    ...
    return generate_html_template(
        ...
        content=content,
        canonical_url="https://payment-debug-14.preview.emergentagent.com/html/blogs",
...
async def get_blog_post_html(slug: str):
    ...
    {{
        ...
        "@graph": [
            {{
                "@type": "BlogPosting",
                "@id": "https://payment-debug-14.preview.emergentagent.com/html/blog/{slug}#article",
                ...
                "mainEntityOfPage": {{
                    "@type": "WebPage",
                    "@id": "https://payment-debug-14.preview.emergentagent.com/html/blog/{slug}"
                }},
                "about": {{
                    "@type": "SoftwareApplication",
                    "@id": "https://payment-debug-14.preview.emergentagent.com/#product"
            ...
            {{
                "@type": "Service",
                "@id": "https://payment-debug-14.preview.emergentagent.com/#service",
    ...
    breadcrumb_schema = generate_breadcrumb_schema([
        {"name": "Home", "url": "https://payment-debug-14.preview.emergentagent.com"},
        {"name": "Blog", "url": "https://payment-debug-14.preview.emergentagent.com/html/blogs"},
        {"name": blog.get('title', ''), "url": f"https://payment-debug-14.preview.emergentagent.com/html/blog/{slug}"}
    ])
    ...
    return generate_html_template(
        ...
        content=content,
        canonical_url=f"https://payment-debug-14.preview.emergentagent.com/html/blog/{slug}",
...
async def get_faqs_html():
    ...
    {{
        ...
        "@graph": [
            {{
                "@type": "FAQPage",
                "@id": "https://payment-debug-14.preview.emergentagent.com/html/faqs#faqpage",
            ...
            {{
                ...
                "potentialAction": [
                    {{
                        ...
                        "target": {{
                            "@type": "EntryPoint",
                            "urlTemplate": "https://payment-debug-14.preview.emergentagent.com/api/external/verify",
                            "httpMethod": "POST",
                    ...
                    {{
                        ...
                        "target": {{
                            "@type": "EntryPoint",
                            "urlTemplate": "https://payment-debug-14.preview.emergentagent.com/register"
                        }}
                    }}
                ]
            }},
            ...
            {{
                "@type": "WebSite",
                "@id": "https://payment-debug-14.preview.emergentagent.com/#website",
                "url": "https://payment-debug-14.preview.emergentagent.com",
                ...
                "potentialAction": {{
                    ...
                    "target": {{
                        "@type": "EntryPoint",
                        "urlTemplate": "https://payment-debug-14.preview.emergentagent.com/blog?search={{search_term_string}}"
                    }},
    ...
    breadcrumb_schema = generate_breadcrumb_schema([
        {"name": "Home", "url": "https://payment-debug-14.preview.emergentagent.com"},
        {"name": "FAQs", "url": "https://payment-debug-14.preview.emergentagent.com/html/faqs"}
    ])
    ...
    return generate_html_template(
        ...
        description=page_description,
        content=content,
        canonical_url="https://payment-debug-14.preview.emergentagent.com/html/faqs",
        structured_data=all_structured_data
    )
