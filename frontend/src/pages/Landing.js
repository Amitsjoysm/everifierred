...
const Landing = () => {
  const structuredData = {
    ...
    url: 'https://blogging-crud.preview.emergentagent.com',
    logo: 'https://blogging-crud.preview.emergentagent.com/logo.png',
    sameAs: [
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        canonicalUrl="https://blogging-crud.preview.emergentagent.com"
