...
const Landing = () => {
  const structuredData = {
    ...
    url: 'https://redis-sync-restart.preview.emergentagent.com',
    logo: 'https://redis-sync-restart.preview.emergentagent.com/logo.png',
    sameAs: [
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        canonicalUrl="https://redis-sync-restart.preview.emergentagent.com"
