...
const Blog = () => {
  ...
  const structuredData = {
    ...
    url: 'https://login-repair-82.preview.emergentagent.com/blog',
    publisher: {
      '@type': 'Organization',
      name: 'MailGuard',
      logo: {
    ...
    blogPost: blogs.map(blog => ({
      ...
      url: `https://login-repair-82.preview.emergentagent.com/blog/${blog.slug}`,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <SEO
        ...
        canonicalUrl="https://login-repair-82.preview.emergentagent.com/blog"
