...
const Blog = () => {
  ...
  const structuredData = {
    ...
    url: 'https://secure-pay-verify.preview.emergentagent.com/blog',
    publisher: {
      '@type': 'Organization',
      name: 'MailGuard',
      logo: {
    ...
    blogPost: blogs.map(blog => ({
      ...
      url: `https://secure-pay-verify.preview.emergentagent.com/blog/${blog.slug}`,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <SEO
        ...
        canonicalUrl="https://secure-pay-verify.preview.emergentagent.com/blog"
