...
const Landing = () => {
  const structuredData = {
    ...
    url: 'https://usermap-debug.preview.emergentagent.com',
    logo: 'https://usermap-debug.preview.emergentagent.com/logo.png',
    sameAs: [
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        canonicalUrl="https://usermap-debug.preview.emergentagent.com"
