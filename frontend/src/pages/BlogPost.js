...
const BlogPost = () => {
  ...
  const jsonLd = {
    ...
    image: 'https://usermap-debug.preview.emergentagent.com/blog-default.png',
    author: {
      '@type': 'Person',
      name: blog.author,
    },
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://usermap-debug.preview.emergentagent.com/blog/${blog.slug}`,
    },
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <SEO
        ...
        keywords={blog.keywords.join(', ')}
        canonicalUrl={`https://usermap-debug.preview.emergentagent.com/blog/${blog.slug}`}
        ogType="article"
        author={blog.author}
