...
async def get_blogs_html():
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {
                "@type": "Blog",
                "@id": "https://responsive-pages-4.preview.emergentagent.com/html/blogs#blog",
                ...
                "url": "https://responsive-pages-4.preview.emergentagent.com/html/blogs",
                "publisher": {
                    "@type": "Organization",
                    "@id": "https://responsive-pages-4.preview.emergentagent.com/#organization"
                },
                "about": {
                    "@type": "SoftwareApplication",
                    "@id": "https://responsive-pages-4.preview.emergentagent.com/#product"
                }
            },
            {
                "@type": "SoftwareApplication",
                ...
                "offers": [
                    {
                        ...
                        "url": "https://responsive-pages-4.preview.emergentagent.com/pricing"
                    },
                    {
                        "@type": "Offer",
                        "name": "Starter Plan",
    ...
    return generate_html_template(
        ...
        content=content,
        canonical_url="https://responsive-pages-4.preview.emergentagent.com/html/blogs",
...
async def get_blog_post_html(slug: str):
    ...
    {{
        ...
        "@graph": [
            {{
                "@type": "BlogPosting",
                "@id": "https://responsive-pages-4.preview.emergentagent.com/html/blog/{slug}#article",
                ...
                "mainEntityOfPage": {{
                    "@type": "WebPage",
                    "@id": "https://responsive-pages-4.preview.emergentagent.com/html/blog/{slug}"
                }},
                "about": {{
                    "@type": "SoftwareApplication",
                    "@id": "https://responsive-pages-4.preview.emergentagent.com/#product"
            ...
            {{
                ...
                "sameAs": [
                    "https://responsive-pages-4.preview.emergentagent.com"
                ]
            }},
            {{
                "@type": "SoftwareApplication",
            ...
            {{
                "@type": "Service",
                "@id": "https://responsive-pages-4.preview.emergentagent.com/#service",
    ...
    breadcrumb_schema = generate_breadcrumb_schema([
        {"name": "Home", "url": "https://responsive-pages-4.preview.emergentagent.com"},
        {"name": "Blog", "url": "https://responsive-pages-4.preview.emergentagent.com/html/blogs"},
        {"name": blog.get('title', ''), "url": f"https://responsive-pages-4.preview.emergentagent.com/html/blog/{slug}"}
    ])
    ...
    return generate_html_template(
        ...
        content=content,
        canonical_url=f"https://responsive-pages-4.preview.emergentagent.com/html/blog/{slug}",
...
async def get_faqs_html():
    ...
    {{
        ...
        "@graph": [
            {{
                "@type": "FAQPage",
                "@id": "https://responsive-pages-4.preview.emergentagent.com/html/faqs#faqpage",
            ...
            {{
                ...
                "potentialAction": [
                    {{
                        ...
                        "target": {{
                            "@type": "EntryPoint",
                            "urlTemplate": "https://responsive-pages-4.preview.emergentagent.com/api/external/verify",
                            "httpMethod": "POST",
                    ...
                    {{
                        ...
                        "target": {{
                            "@type": "EntryPoint",
                            "urlTemplate": "https://responsive-pages-4.preview.emergentagent.com/register"
                        }}
                    }}
                ]
            }},
            ...
            {{
                "@type": "WebSite",
                "@id": "https://responsive-pages-4.preview.emergentagent.com/#website",
                "url": "https://responsive-pages-4.preview.emergentagent.com",
                ...
                "potentialAction": {{
                    ...
                    "target": {{
                        "@type": "EntryPoint",
                        "urlTemplate": "https://responsive-pages-4.preview.emergentagent.com/blog?search={{search_term_string}}"
                    }},
    ...
    breadcrumb_schema = generate_breadcrumb_schema([
        {"name": "Home", "url": "https://responsive-pages-4.preview.emergentagent.com"},
        {"name": "FAQs", "url": "https://responsive-pages-4.preview.emergentagent.com/html/faqs"}
    ])
    ...
    return generate_html_template(
        ...
        description=page_description,
        content=content,
        canonical_url="https://responsive-pages-4.preview.emergentagent.com/html/faqs",
        structured_data=all_structured_data
    )
