...
const Landing = () => {
  const structuredData = {
    ...
    url: 'https://email-verify-sync-1.preview.emergentagent.com',
    logo: 'https://email-verify-sync-1.preview.emergentagent.com/logo.png',
    sameAs: [
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        canonicalUrl="https://email-verify-sync-1.preview.emergentagent.com"
