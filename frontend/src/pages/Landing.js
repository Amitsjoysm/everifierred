...
const Landing = () => {
  const structuredData = {
    ...
    url: 'https://secure-pay-verify.preview.emergentagent.com',
    logo: 'https://secure-pay-verify.preview.emergentagent.com/logo.png',
    sameAs: [
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        canonicalUrl="https://secure-pay-verify.preview.emergentagent.com"
