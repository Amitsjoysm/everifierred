...
const BlogPost = () => {
  ...
  const jsonLd = {
    ...
    image: 'https://email-verify-sync-1.preview.emergentagent.com/blog-default.png',
    author: {
      '@type': 'Person',
      name: blog.author,
    },
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://email-verify-sync-1.preview.emergentagent.com/logo.png',
      },
    },
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://email-verify-sync-1.preview.emergentagent.com/blog/${blog.slug}`,
    },
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <SEO
        ...
        keywords={blog.keywords.join(', ')}
        canonicalUrl={`https://email-verify-sync-1.preview.emergentagent.com/blog/${blog.slug}`}
        ogType="article"
        author={blog.author}
